...
public:
    ...
    /* 0x710 */ s16 look_timer;
    /* 0x714 */ cXyz target_pos;
    /* 0x720 */ cXyz look_pos;
    /* 0x72C */ f32 field_0x72c;
    /* 0x730 */ f32 field_0x730;
    /* 0x734 */ u8 no_draw;
    /* 0x738 */ f32 rain_timer;
    /* 0x73C */ s16 timer[10];
    /* 0x750 */ s16 talk_timer;
    /* 0x752 */ s16 demo_mode;
    /* 0x754 */ s16 demo_timer;
    /* 0x756 */ u16 field_0x756;
    /* 0x758 */ s16 field_0x758;
    /* 0x75A */ u8 field_0x75a[0x75c - 0x75a];
    /* 0x75C */ s16 field_0x75c;
    /* 0x760 */ cXyz demo_cam_eye;
    /* 0x76C */ cXyz demo_cam_center;
    /* 0x778 */ cXyz demo_cam_target;
    /* 0x784 */ cXyz demo_cam_morf;
    ...
    /* 0x7D4 */ u8 fishing_timer;
    /* 0x7D5 */ u8 du_near_timer;
